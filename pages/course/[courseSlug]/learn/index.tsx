...
import { SidebarProvider, useSidebar } from '../../../../app/modules/shared/providers/sidebar.provider'
import { setLearnCourse, setStateActiveContent } from '../../../../app/store/course/learn-course.slice'
      ...
      <SidebarProvider defaultIsOpen={!isMobile}>
        <Box>
          <Stack spacing={0}>
            ...
            <LearnTopBar />
            {/* CONTENT */}
            <HStack spacing={0} alignItems="start" overflowX="hidden" position={'relative'}>
              <CourseInfo />
