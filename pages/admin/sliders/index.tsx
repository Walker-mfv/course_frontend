...
const PageTableToolbar = () => {
  ...
  const actions = useMemo(() => {
    return [<Filter key={1} data={filters} />, <MainCreateButton size="5xl" key={3} formComponent={form} />]
  }, [filters, form])
...
const PageTable = () => {
  ...
  return <AdminTable isLoading={rowsQ.isLoading} isError={rowsQ.isError} columns={columns} rows={rows} />
}
