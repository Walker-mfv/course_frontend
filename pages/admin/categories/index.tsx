...
import { FormParamsProvider, useFormParams } from '../../../app/modules/admin/hooks/form-params-provider'
...
import { CATEGORY_SEARCH_MENU, CATEGORY_STATUS_SELECT_DATA } from '../../../app/utils/data/category.data'
          ...
          <SimpleGrid columns={12} spacing={{ base: 8, md: 4 }}>
            ...
            <GridItem colSpan={{ base: 12, md: 8, lg: 9 }}>
              <Stack spacing={2} flexDir="column" alignItems={'stretch'}>
                <PageTitle title={Helper.lodash.capitalize(Helper.pluralize.plural(modelName))} />
                <PageTableToolbar />
                <PageTable />
              </Stack>
            </GridItem>
