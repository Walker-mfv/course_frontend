...
export default class PathHelper {
  ...
  static getAdminInstructorViewPath(instructorId: string, section: TInstructorSection) {
    return this.getAdminPerformancePath('instructors') + `/${instructorId}/${this.getInstructorSectionPath(section)}`
  }
  ...
  static getAdminCourseFormPath(id: string, section?: TCourseFormSection) {
    return `/${this.module.admin}/${this.adminPages.course}${this.getCourseFormPath(id, section)}`
  }

  static getCourseFormBackPath(roleName: string) {
    const backUrl =
      roleName == 'Instructor' ? PathHelper.getInstructorPath('courses') : PathHelper.getAdminControllerPage('courses')
    return backUrl
  }
  ...
  static getInstructorCourseFormPath(id: string, section?: TCourseFormSection) {
    return `/${this.module.instructor}/${this.instructorPages.course}${this.getCourseFormPath(id, section)}`
  }
