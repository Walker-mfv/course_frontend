...
import { ROLE_STATUS_SELECT_DATA } from 'app/utils/data/role.data'
import { roleVldSchema } from 'app/validations/role.validation'
      ...
      {loading ? (
        ...
        <Stack>
          <SimpleGrid columns={1} spacing={2}>
            ...
            <GridItem colSpan={1}>
              <MyTextArea field="description" label={'Description'} register={register} error={errors.description} />
            </GridItem>
          </SimpleGrid>
