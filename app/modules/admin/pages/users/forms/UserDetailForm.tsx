...
export default function UserDetailForm({ userId, onUserCreated }: UserDetailFormProps) {
  ...
  const { handleUpload, uploadProgress, getImgSrcFuncRef } = useUploadImage(AVATAR_DIR, item?.profile.avatar)
            ...
            <VStack align="stretch" spacing={4}>
              ...
              <SimpleGrid columns={2} spacing={2}>
                ...
                >
                  <MySelect
                    required
                    placeholder={`${Helper.lodash.upperFirst(lan.SELECT)} ${FieldLabel['user.role']}`}
                    field="role"
