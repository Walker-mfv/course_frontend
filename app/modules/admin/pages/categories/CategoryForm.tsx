    ...
    <>
      <form onSubmit={onSubmit}>
        <Stack>
          ...
          <Stack>
            <MyInput autoFocus required field="name" label={'Name'} register={register} error={errors.name} />
            <MyInput required field="slug" label={'Slug'} error={errors.slug} register={register} />
            <MySelect
              required
              placeholder="None"
              field="parent"
