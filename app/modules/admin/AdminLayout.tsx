...
import Sidebar, { ADMIN_SIDEBAR_EXPANDED_WIDTH, ADMIN_SIDEBAR_SM_WIDTH } from './parts/Sidebar/Sidebar'
  ...
  return (
    ...
    >
      ...
      <VStack
        minH={'100vh'}
        ml={{
          lg: navSize == 'small' ? ADMIN_SIDEBAR_SM_WIDTH + 'px' : ADMIN_SIDEBAR_EXPANDED_WIDTH + 'px',
        }}
        flex={1}
