...
const PermissionManagementContext = createContext<IPermissionManagementProvider>({} as IPermissionManagementProvider)
...
export function PermissionManagementProvider({ children }: { children: ReactNode }) {
  ...
  return <PermissionManagementContext.Provider value={state}>{children}</PermissionManagementContext.Provider>
}
