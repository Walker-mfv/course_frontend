...
function Pricing() {
  return (
    <CoursePageSection title={'Pricing'}>
      <Stack spacing={4}>
        <Text>Course Price Tier</Text>
        <Text>
          Please select the price tier for your course below and click Save. The list price that students will see in
          other currencies is determined using the price tier matrix.
        </Text>
        <Text>
