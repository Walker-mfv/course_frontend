...
const placeholders: string[] = ['Example: No programming experience needed. You will learn everything you need to know']
    ...
    <FormProvider {...methods}>
      <AnswerFieldArrayProvider formName={formName} minQty={minQty} fieldName={fieldName} {...fieldArrayMethods}>
        <form onSubmit={onSubmit}>
          <Stack spacing={2}>
            <Heading fontSize={'md'}>What are the requirements or prerequisites for taking your course?</Heading>
            <Text>
