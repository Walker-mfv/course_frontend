import { AspectRatio, Box, Button, GridItem, Image, Input, SimpleGrid, Stack, Text } from '@chakra-ui/react'
        ...
        >
          {!cropMode ? (
            <AspectRatio ratio={aspectRatio}>
              <Image alt="lecture-image" src={newSrc || src || AppImg.MEDIA_PLACEHOLDER} />
            </AspectRatio>
          ) : (
            <MyImageCropper aspectRatio={aspectRatio} childFuncRef={cropFuncRef} imageSrc={newSrc!} />
          )}
        </GridItem>
