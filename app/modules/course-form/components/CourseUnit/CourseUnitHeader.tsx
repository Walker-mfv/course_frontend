...
import { deleteUnit, selectFormCourseUnitNo } from 'app/store/course/form-course.slice'
...
const CourseUnitHeader = (props: CourseUnitHeaderProps) => {
  ...
  const renderForm = useMemo(() => {
    switch (unitType) {
      case 'lecture':
        return <CourseLectureForm sectionId={sectionId} unitId={unitId} onClose={() => setEditMode(false)} />
      case 'quiz':
        ...
        <AccordionButton as={'div'} className="no-focus-shadow" _hover={{}}>
          ...
          >
            ...
            >
              ...
              <DragButton {...dragButtonEvents} onClick={(e) => e.stopPropagation()} aria-label="" />
            </HStack>
