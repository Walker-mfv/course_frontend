...
import { LECTURE_RESOURCE_DIR } from 'app/utils/constants/firebase.constant'
...
const UploadLectureVideo = () => {
  ...
  return <UploadLectureFile accept="video/mp4,video/x-m4v,video/*" dirPath={LECTURE_RESOURCE_DIR} onSave={onSave} />
}
...
export default function AddLectureVideo() {
  ...
  return (
    <Tabs isLazy variant="enclosed">
      ...
      <TabPanels>
        <TabPanel>
          {!processingFile ? <UploadLectureVideo /> : <LibraryTable rows={[processingFile]} type="processing" />}
        </TabPanel>
        <TabPanel>
