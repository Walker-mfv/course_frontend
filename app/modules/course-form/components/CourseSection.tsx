  ...
  return (
    <>
      {!editMode ? (
        <AccordionButton as={'div'} className="no-focus-shadow" _hover={{}}>
          ...
          >
            ...
            >
              ...
              <DragButton {...props.dragButtonEvents} onClick={(e) => e.stopPropagation()} />
            </HStack>
            <HStack>
              <AccordionIcon />
            </HStack>
        ...
        <CourseSectionForm sectionIndex={props.sectionIndex} onClose={() => setEditMode(false)} />
      )}
    </>
  )
}
    ...
    <>
      ...
      >
        <Stack opacity={opacity} spacing={0}>
          {/* HEADER */}
          <Header dragButtonEvents={dragButtonEvents} sectionIndex={sectionIndex} sectionId={sectionId} />
