...
const AnswerFieldArrayContext = createContext<IAnswerFieldArray & TMore>({} as IAnswerFieldArray & TMore)
...
export const AnswerFieldArrayProvider = ({
  ...
  return <AnswerFieldArrayContext.Provider value={state}>{children}</AnswerFieldArrayContext.Provider>
}
