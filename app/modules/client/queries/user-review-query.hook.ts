...
import { apiDeleteUserReview, apiUpdateUserReview, fetchUserReview } from '../../../apis/user/user-review.api'
...
export const useUpdateUserReview = () => {
  ...
  return useMutation(
    (data: { courseId: string; data: Partial<IReview> }) => apiUpdateUserReview(data.courseId, data.data),
    {
      onSuccess: (_, data) => {
