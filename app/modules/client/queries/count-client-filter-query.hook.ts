...
export const useCountClientFilterQuery = (fields: string[], options?: UseQueryOptions<ICountResult[]>) => {
  const clientQuery = useFilterCoursesClientQuery()
  return useQuery<ICountResult[]>([RQK_COUNT_CLIENT_FILTER, clientQuery, fields], countClientFilter, {
