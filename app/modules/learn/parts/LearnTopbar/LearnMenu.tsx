...
import { useAddToWishlist, useDeleteFromWishlist, useWishlistCourseIdsQuery } from '@client/queries/wishlist-query.hook'
...
export default function LearnMenu() {
  return (
    <Menu>
      <MenuButton size="sm" as={IconButton} icon={<Icon as={AppIcon.moreVertical} />}></MenuButton>
