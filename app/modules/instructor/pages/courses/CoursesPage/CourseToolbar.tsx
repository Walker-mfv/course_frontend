...
import { Button, Flex, Input, InputGroup, InputRightElement, Select, useControllableState } from '@chakra-ui/react'
...
const SearchBar = () => {
  ...
  return (
    <InputGroup w={{ md: '300px' }}>
      <Input spellCheck={false} placeholder="Search your courses" value={value} onChange={onChange} />
...
const NewCourseButton = () => {
  ...
  return (
    <Button isDisabled={adding} ml={{ base: 2, md: 0 }} colorScheme={'purple'} onClick={onNewClick}>
      New Course
    </Button>
  )
}
