...
const InstructorParamsContext = createContext<IInstructorParamsProvider>({} as IInstructorParamsProvider)
...
export function InstructorParamsProvider({
  ...
  const [viewInstructorId, setViewInstructorId] = useState<string | undefined>(defaultViewInstructorId)
  ...
  return <InstructorParamsContext.Provider value={state}>{children}</InstructorParamsContext.Provider>
}
