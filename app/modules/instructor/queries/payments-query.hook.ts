...
export const usePaymentsQuery = (
  ...
  return useQuery<IPayment[]>([RQK_PAYMENTS, viewInstructorId, clientQuery, page, rowsPerPage], fetchPayments, {
    notifyOnChangeProps: 'tracked',
    ...options,
  })
}

export const useCountPaymentsQuery = (clientQuery?: IClientUrlParams, viewInstructorId?: string) => {
  return useQuery<number>([RQK_PAYMENTS, viewInstructorId, clientQuery, , 'count'], countPayments, {
...
export const usePendingPaymentsQuery = (viewInstructorId?: string, options?: UseQueryOptions<IPayment[]>) => {
  return useQuery<IPayment[]>([RQK_PENDING_PAYMENTS, viewInstructorId], () => fetchPendingPayments(viewInstructorId), {
    notifyOnChangeProps: 'tracked',
    ...options,
  })
}
