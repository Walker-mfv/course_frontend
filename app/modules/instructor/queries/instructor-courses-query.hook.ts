...
import { countInstructorCourses, fetchInstructorCourses } from '../../../apis/user/user-instructor.api'
...
export const useCountInstructorCoursesQuery = () => {
  ...
  const clientQuery = useInstructorCoursesUrlParams()
  return useQuery<number>([RQK_INSTRUCTOR_COURSES, clientQuery, viewInstructorId, 'count'], countInstructorCourses, {
