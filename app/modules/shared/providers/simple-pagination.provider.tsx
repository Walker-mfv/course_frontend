...
const SimplePaginationContext = createContext<ISimplePaginationProvider>({} as ISimplePaginationProvider)
...
export function SimplePaginationProvider({
  ...
  return <SimplePaginationContext.Provider value={state}>{children}</SimplePaginationContext.Provider>
}
