...
export const useMyNotificationsQuery = (options?: UseInfiniteQueryOptions<INotification[]>) => {
  ...
  return useInfiniteQuery<INotification[]>([RQK_MY_NOTIFICATIONS, ROWS_PER_PAGE], fetchMyNotifications, {
    notifyOnChangeProps: 'tracked',
    keepPreviousData: true,
    getNextPageParam: (_lastPage, pages) => QueryHelper.getNextPageParams(pages.length, ROWS_PER_PAGE, count),
