import { Avatar, Box, FormControl, FormHelperText, Icon, IconButton, useDisclosure } from '@chakra-ui/react'
...
export default function EditableAvatar({
  ...
  return (
    <FormControl isInvalid={!!error}>
      ...
      <input onChange={onFileChange} style={{ display: 'none' }} ref={fileRef} type={'file'} accept=".png,.jpg,.jpeg" />
      <MyImageCropperModal
        isOpen={isOpen}
        onOpen={onOpen}
        onClose={onClose}
